...
export class PluginSandbox extends EventEmitter {
  ...
  async executeInSandbox(
    pluginFunction: (...args: unknown[]) => any,
    context: unknown,
    timeout?: number
  ): Promise<unknown> {
    ...
    try {
      ...
      const sandboxedContext = this.createSandboxedContext(context as Record<string, unknown>);
  ...
  private createSandboxedContext(originalContext: Record<string, unknown>): Record<string, unknown> {
